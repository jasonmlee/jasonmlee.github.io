...
MVO is widely used by professionals and institutions to systematically manage investment portfolios. 

### Background
I’m Jason Lee, a Chartered Financial Analyst (CFA) with over five years of experience in the financial industry. 
Currently, I’m pursuing a Master of Data Science at the University of British Columbia. 
While I’m not a financial advisor and this tutorial isn’t financial advice, I aim to share a practical framework that people can use to test their ideas and improve their investing. 
Keep in mind that all investing involves risk, so approach these concepts with caution.

### Workflow
1. Problem Definition: Allocating Investments Efficiently
2. Imports
3. Data Collection: Retreiving data from yfinance (Yahoo finance)
4. Portfolio Construction: Using Riskfolio-Lib to create efficient portfolios
5. Visualization: Displaying results through efficient frontiers and allocation breakdowns
...
To illustrate the concept of diversification and optimal allocation, we’ll use a sample portfolio. This portfolio includes a diverse mix of stocks, gold, real estate, and bonds to represent different asset classes. By applying Mean-Variance Optimization (MVO), we’ll determine how to allocate investments efficiently.
